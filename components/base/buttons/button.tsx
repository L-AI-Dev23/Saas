...
export const styles = sortCx({
    ...
    colors: {
        ...
        secondary: {
            root: [
                "bg-uui-primary text-fg-uui-secondary shadow-xs-skeuomorphic ring-1 ring-border-uui-primary ring-inset hover:bg-primary_hover hover:text-secondary_hover data-loading:bg-primary_hover",
                // Icon styles
        ...
        tertiary: {
            root: [
                "text-uui-tertiary hover:bg-primary_hover hover:text-uui-tertiary_hover data-loading:bg-primary_hover",
                // Icon styles
                "*:data-icon:text-fg-quaternary hover:*:data-icon:text-fg-quaternary_hover",
            ].join(" "),
        },
        ...
        "link-gray": {
            root: [
                "justify-normal rounded p-0! text-uui-tertiary hover:text-uui-tertiary_hover",
                // Inner text underline
        ...
        "secondary-destructive": {
            root: [
                "bg-uui-primary text-error-primary shadow-xs-skeuomorphic ring-1 ring-error_subtle outline-error ring-inset hover:bg-error-primary hover:text-error-primary_hover data-loading:bg-error-primary",
                // Icon styles
