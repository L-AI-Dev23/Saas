...
export const styles = {
    secondary:
        "bg-uui-primary text-fg-quaternary shadow-xs-skeuomorphic ring-1 ring-border-uui-primary ring-inset hover:bg-primary_hover hover:text-fg-quaternary_hover disabled:shadow-xs",
