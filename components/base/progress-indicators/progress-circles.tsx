...
const sizes = sortCx({
    xxs: {
        strokeWidth: 6,
        radius: 29,
        valueClass: "text-sm font-semibold text-fg-uui-primary",
        labelClass: "text-xs font-medium text-uui-tertiary",
        halfCircleTextPosition: "absolute bottom-0.5 text-center",
    },
    xs: {
        strokeWidth: 16,
        radius: 72,
        valueClass: "text-display-xs font-semibold text-fg-uui-primary",
        labelClass: "text-xs font-medium text-uui-tertiary",
        halfCircleTextPosition: "absolute bottom-0.5 text-center",
    },
    sm: {
        strokeWidth: 20,
        radius: 90,
        valueClass: "text-display-sm font-semibold text-fg-uui-primary",
        labelClass: "text-xs font-medium text-uui-tertiary",
    ...
    md: {
        strokeWidth: 24,
        radius: 108,
        valueClass: "text-display-md font-semibold text-fg-uui-primary",
        labelClass: "text-sm font-medium text-uui-tertiary",
        halfCircleTextPosition: "absolute bottom-1 text-center",
    },
    lg: {
        strokeWidth: 28,
        radius: 126,
        valueClass: "text-display-lg font-semibold text-fg-uui-primary",
        labelClass: "text-sm font-medium text-uui-tertiary",
...
export const ProgressBarCircle = ({ value, min = 0, max = 100, size, label, valueFormatter }: ProgressBarProps) => {
    ...
    const textPosition = label ? "absolute text-center" : "absolute text-fg-uui-primary";
