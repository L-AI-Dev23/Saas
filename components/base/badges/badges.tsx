...
const withPillTypes = {
    ...
    [badgeTypes.badgeModern]: {
        ...
        styles: {
            gray: {
                root: "bg-uui-primary text-fg-uui-secondary ring-border-uui-primary",
...
const withBadgeTypes = {
    ...
    [badgeTypes.badgeModern]: {
        common: "size-max flex items-center whitespace-nowrap rounded-md ring-1 ring-inset bg-uui-primary text-fg-uui-secondary ring-border-uui-primary shadow-xs",
