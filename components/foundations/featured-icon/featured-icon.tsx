...
const styles = sortCx({
    ...
    gradient: {
        ...
        colors: {
            ...
            gray: "before:border-utility-neutral-200 before:bg-utility-neutral-50 after:bg-uui-secondary-solid",
    ...
    dark: {
        ...
        colors: {
            ...
            gray: "bg-uui-secondary-solid before:border-utility-neutral-200/12",
    ...
    modern: {
        base: "bg-uui-primary shadow-xs-skeuomorphic ring-1 ring-border-uui-primary ring-inset",
        sizes: {
    ...
    "modern-neue": {
        ...
        colors: {
            brand: "",
            gray: "text-fg-secondary ring-border-uui-primary",
            error: "",
            warning: "",
            success: "",
        },
