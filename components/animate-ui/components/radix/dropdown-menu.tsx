...
function DropdownMenuContent({
  ...
  return (
    <DropdownMenuContentPrimitive
      ...
      {...props}
    >
      <DropdownMenuHighlightPrimitive className="absolute inset-0 bg-sidebar-accent z-0 rounded-sm">
        {children}
  ...
  return (
    <DropdownMenuHighlightItemPrimitive disabled={disabled}>
      <DropdownMenuCheckboxItemPrimitive
        disabled={disabled}
        className={cn(
          "focus:text-sidebar-accent-foreground relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled=true]:pointer-events-none data-[disabled=true]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
          className,
        )}
        checked={checked}
        {...props}
  ...
  return (
    <DropdownMenuHighlightItemPrimitive disabled={disabled}>
      <DropdownMenuSubTriggerPrimitive
        ...
        data-inset={inset}
        className={cn(
          'focus:text-sidebar-accent-foreground data-[state=open]:text-sidebar-accent-foreground flex cursor-default items-center rounded-sm px-2 py-1.5 text-sm outline-hidden select-none data-[inset]:pl-8',
