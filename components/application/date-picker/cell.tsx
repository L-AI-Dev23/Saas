        ...
        <AriaCalendarCell
            ...
            className={({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, isOutsideMonth }) => {
                ...
                return cx(
                    ...
                    isInRange && isDisabled && "bg-uui-secondary",
                    isSelected && isRangeCalendar && "bg-uui-secondary",
                    ...
                    isLastDayOfMonth &&
                        ...
                        isBeforeEnd &&
                        isRangeCalendar &&
                        "after:absolute after:inset-0 after:translate-x-full after:bg-gradient-to-l after:from-transparent after:to-bg-uui-secondary in-[[role=gridcell]:last-child]:after:hidden",
                    ...
                    isFirstDayOfMonth &&
                        ...
                        isAfterStart &&
                        isRangeCalendar &&
                        "after:absolute after:inset-0 after:-translate-x-full after:bg-gradient-to-r after:from-transparent after:to-bg-uui-secondary in-[[role=gridcell]:first-child]:after:hidden",
                );
            }}
        >
            {({ isDisabled, isFocusVisible, isSelectionStart, isSelectionEnd, isSelected, formattedDate }) => {
                ...
                return (
                    <div
                        className={cx(
                            "relative flex size-full items-center justify-center rounded-full text-sm text-fg-uui-secondary hover:text-secondary_hover",
                            // Disabled state.
                            isDisabled && "text-fg-uui-secondary/50",
                            ...
                            !isSelected && isTodayDate ? "bg-uui-secondary font-medium hover:bg-secondary_hover" : "",
                        )}
                    >
                        {formattedDate}
