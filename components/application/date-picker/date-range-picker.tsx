...
export const DateRangePicker = ({ value: valueProp, defaultValue, onChange, onApply, onCancel, size = "sm", ...props }: DateRangePickerProps) => {
    ...
    return (
        <AriaDateRangePicker aria-label="Date range picker" shouldCloseOnSelect={false} {...props} value={value} onChange={setValue}>
            ...
            >
                <AriaDialog aria-label="Date range picker" className="flex rounded-2xl bg-uui-primary shadow-xl ring ring-secondary_alt focus:outline-hidden">
                    {({ close }) => (
                        <>
                            <div className="hidden w-38 flex-col gap-0.5 border-r border-solid border-uui-secondary p-3 lg:flex">
                            ...
                            <div className="flex flex-col">
                                ...
                                />
                                <div className="flex justify-between gap-3 border-t border-uui-secondary p-4">
