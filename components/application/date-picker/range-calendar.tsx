    ...
    return (
        <button
            ...
            className={cx(
                ...
                isSelected ? "bg-uui-secondary text-secondary_hover hover:bg-secondary_hover" : "text-fg-uui-secondary hover:bg-primary_hover hover:text-secondary_hover",
                className,
            )}
        >
            {children}
        ...
        <ContextWrapper>
            ...
            >
                <div className="flex flex-col gap-3 px-6 py-5 md:gap-2">
                    ...
                    {!isDesktop && (
                        <div className="flex items-center gap-2 md:hidden">
                            ...
                            <div className="text-md text-uui-quaternary">–</div>
                        ...
                        <AriaCalendarGridHeader>
                            {(day) => (
                                <AriaCalendarHeaderCell className="border-b-4 border-transparent p-0">
                                    <div className="flex size-10 items-center justify-center text-sm font-medium text-fg-uui-secondary">{day.slice(0, 2)}</div>
                ...
                {visibleDurationMonths > 1 && (
                    <div className="flex flex-col gap-3 border-l border-uui-secondary px-6 py-5">
